...
def get_thread_parent_message_user_id(client: WebClient, channel_id: str, thread_ts: str) -> str:
    ...
    :param channel_id: channel id of thread
    ...
    try:
        ...
        original_user_id = messages[0]["user"]
        logger.info(
            {
...
def load_file_uploaded_by_user(client: WebClient, file_id: str, save_dir_path: str) -> str:
    """
    Load file uploaded by user to cloud run.
    :param client: slack web client
